namespace Cars.Tests.JustMock.Mocks
{
    ...
    public class JustMockCarsRepository : CarRepositoryMock, ICarsRepositoryMock
    {
        protected override void ArrangeCarsRepositoryMock()
        {
            ...
            Mock.Arrange(() => this.CarsData.SortedByMake()).Returns(this.FakeCarCollection.Where(c => c.Make == "Audi").ToList());
            Mock.Arrange(() => this.CarsData.SortedByYear()).Returns(this.FakeCarCollection.Where(c => c.Make == "Opel").ToList());
        }
    }
}
