namespace Cars.Tests.JustMock.Mocks
{
    ...
    public class MoqCarsRepository : CarRepositoryMock, ICarsRepositoryMock
    {
        protected override void ArrangeCarsRepositoryMock()
        {
            ...
            mockedCarsRepository.Setup(r => r.SortedByMake()).Returns(this.FakeCarCollection.Where(c => c.Make == "Audi").ToList());
            mockedCarsRepository.Setup(r => r.SortedByYear()).Returns(this.FakeCarCollection.Where(c => c.Make == "Opel").ToList());
